...
class _$_WebPageModel implements _WebPageModel {
  ...
  @override
  String toString() {
    return 'WebPageModel(icon: $icon, title: $title, subTitle: $subTitle, handle: $handle, url: $url)';
  }
...
abstract class _WebPageModel implements WebPageModel {
